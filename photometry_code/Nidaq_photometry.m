    ...
    case 'WaitToStart'
        ...
        if S.GUI.Photometry
            if S.GUI.Modulation == 0
                ...
                nidaq.LED1              = S.GUI.LED1_Amp*ones(nidaq.duration,1);
                nidaq.LED2              = S.GUI.LED2_Amp*ones(nidaq.duration,1);
            end
        else
            nidaq.LED1              = S.GUI.LED1_Amp*zeros(nidaq.duration,1);
            nidaq.LED2              = S.GUI.LED2_Amp*zeros(nidaq.duration,1);
        end
