function [trialsNames, trialsMatrix]=CuedReward_Phase(S,PhaseName)

switch PhaseName
	case 'RewardAPunishB' 
        trialsNames={'Cue A Reward ','Cue A Omission',...
            'Cue B Punishment','Cue B Omission',...
            'Uncued Reward','Uncued Punishment','Uncued nothing'};
        trialsMatrix=[...
    ...
    case 'RewardValues' 
        ...
        %  1.type, 2.proba, 3.sound, 4.delay,   5.valve,                6.Outcome         	7.Marker
            ...
            4,   0.175,     2,    S.GUI.Delay,	S.GUI.RewadValve,       S.InterRew,         double('o');...    
    ...
    case 'RewardB' 
        ...
        %  1.type, 2.proba, 3.sound, 4.delay,   5.valve,                6.Outcome         	7.Marker
            ...
            6,   0,       3,    S.GUI.Delay,   S.GUI.OmissionValve,    S.InterRew,         double('d')];
    ...
    case 'PunishA' 
        ...
        trialsMatrix=[...
        %  1.type, 2.proba, 3.sound, 4.delay,   5.valve,                6.Outcome         	7.Marker
            1,   0.5,     1,    S.GUI.Delay,   S.GUI.PunishValve,      S.GUI.PunishTime,         double('d');...   
            2,   0.1,     1,    S.GUI.Delay,   S.GUI.OmissionValve,    S.InterRew,         double('s');...   
            3,   0.1,     2,    S.GUI.Delay,   S.GUI.OmissionValve,    S.InterRew,         double('s');...   
            4,   0.2,     3,    S.GUI.Delay,   S.GUI.PunishValve,      S.GUI.PunishTime,         double('d');...    
            5,   0.1,     3,    S.GUI.Delay,   S.GUI.OmissionValve,    S.InterRew,         double('s');...    
            6,   0,       3,    S.GUI.Delay,   S.GUI.OmissionValve,    S.InterRew,       double('d')];
        
    case 'Air_Stim_Pairing' 
        trialsNames={'Baseline','Air_Stim_Pairing',...
            'Stim_Air_Pairing','Pairing_Air_Stim',...
            };
        trialsMatrix=[...
        %  1.type, 2.proba, 3.BNC    5.valve,                6Outcome         	7.Marker
            1,   0.25,     [],     S.GUI.PunishValve,      S.GUI.PunishTime,         double('d');...   
            2,   0.25,     2,      S.GUI.PunishValve,      S.InterRew,         double('s');...   
            3,   0.25,     2,      S.GUI.PunishValve,      S.InterRew,         double('s');...   
            4,   0.25,     2,      S.GUI.PunishValve,      S.GUI.PunishTime,         double('d')];    
